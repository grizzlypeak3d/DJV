...
DJV is an open source application for media playback and review. It plays back
high-resolution image sequences and movies in real time, with audio, A/B
...
- Timeline support with OpenTimelineIO, including bundles and proxy/full
  resolution switching with media references
