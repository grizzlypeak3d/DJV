...
namespace djv
{
    namespace models
    {
        ...
        //! Command information.
        struct DJV_MODELS_API_TYPE CommandInfo
        {
            std::string name;
            std::string doc;
        };
        ...
        class DJV_MODELS_API_TYPE CommandsModel : public std::enable_shared_from_this<CommandsModel>
        {
        ...
        public:
            DJV_MODELS_API ~CommandsModel();

            //! Create a new model.
            DJV_MODELS_API static std::shared_ptr<CommandsModel> create(
            ...
            //! Remove a command.
            DJV_MODELS_API void remove(const std::string& name);

            //! Get information about the commands, sorted by name.
            DJV_MODELS_API std::vector<CommandInfo> getCommands() const;

            //! Execute a command. Errors are logged and false is returned.
            DJV_MODELS_API bool exec(
                const std::string& name,
